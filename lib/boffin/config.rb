module Boffin
  ...
  # likely not need to work with Config directly.
  class Config
    ...
    # @option opts [Integer] :hours_window_secs
    # @option opts [Integer] :days_window_secs
    # @option opts [Integer] :months_window_secs
    # @option opts [Integer] :cache_expire_secs
    # @yield [self]
